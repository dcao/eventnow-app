...
class ClubData {
  ...
  static Future<ClubData> fetchData() async {
    final response = await http.get('http://ec2-18-189-29-47.us-east-2.compute.amazonaws.com:8080/getClub');
...
class EventData {
  ...
  static Future<EventData> fetchData() async {
    final response = await http.get('http://ec2-18-189-29-47.us-east-2.compute.amazonaws.com:8080/getEvent');
    if (response.statusCode == 200) {
      // If server returns an OK response, parse the JSON.
